...
const routes = {
  ...
  'profile.accounts.unlink': {
    ...
    tokens: [{"old":"/profile/accounts/:id","type":0,"val":"profile","end":""},{"old":"/profile/accounts/:id","type":0,"val":"accounts","end":""},{"old":"/profile/accounts/:id","type":1,"val":"id","end":""}],
  ...
  'profile.set-preferred-provider': {
    ...
    tokens: [{"old":"/profile/set-preferred-provider","type":0,"val":"profile","end":""},{"old":"/profile/set-preferred-provider","type":0,"val":"set-preferred-provider","end":""}],
  ...
  'fitbit.redirect': {
    methods: ["GET","HEAD"],
    pattern: '/auth/fitbit',
    tokens: [{"old":"/auth/fitbit","type":0,"val":"auth","end":""},{"old":"/auth/fitbit","type":0,"val":"fitbit","end":""}],
    types: placeholder as Registry['fitbit.redirect']['types'],
  },
  'fitbit.callback': {
    methods: ["GET","HEAD"],
    pattern: '/auth/fitbit/callback',
    tokens: [{"old":"/auth/fitbit/callback","type":0,"val":"auth","end":""},{"old":"/auth/fitbit/callback","type":0,"val":"fitbit","end":""},{"old":"/auth/fitbit/callback","type":0,"val":"callback","end":""}],
  ...
  'friends.create': {
    methods: ["GET","HEAD"],
    pattern: '/friends/add',
    tokens: [{"old":"/friends/add","type":0,"val":"friends","end":""},{"old":"/friends/add","type":0,"val":"add","end":""}],
    types: placeholder as Registry['friends.create']['types'],
  },
  'friends.search': {
    methods: ["POST"],
    pattern: '/friends/search',
    tokens: [{"old":"/friends/search","type":0,"val":"friends","end":""},{"old":"/friends/search","type":0,"val":"search","end":""}],
    types: placeholder as Registry['friends.search']['types'],
  },
  'friends.show': {
    methods: ["GET","HEAD"],
    pattern: '/friends/:userId',
    tokens: [{"old":"/friends/:userId","type":0,"val":"friends","end":""},{"old":"/friends/:userId","type":1,"val":"userId","end":""}],
  ...
  'friends.destroy': {
    methods: ["DELETE"],
    pattern: '/friends/:id',
    tokens: [{"old":"/friends/:id","type":0,"val":"friends","end":""},{"old":"/friends/:id","type":1,"val":"id","end":""}],
  ...
  'competitions.create': {
    ...
    tokens: [{"old":"/competitions/create","type":0,"val":"competitions","end":""},{"old":"/competitions/create","type":0,"val":"create","end":""}],
  ...
  'competitions.show': {
    ...
    tokens: [{"old":"/competitions/:id","type":0,"val":"competitions","end":""},{"old":"/competitions/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['competitions.show']['types'],
  },
  'competitions.edit': {
    methods: ["GET","HEAD"],
    pattern: '/competitions/:id/edit',
    tokens: [{"old":"/competitions/:id/edit","type":0,"val":"competitions","end":""},{"old":"/competitions/:id/edit","type":1,"val":"id","end":""},{"old":"/competitions/:id/edit","type":0,"val":"edit","end":""}],
  ...
  'competitions.launch': {
    ...
    tokens: [{"old":"/competitions/:id/launch","type":0,"val":"competitions","end":""},{"old":"/competitions/:id/launch","type":1,"val":"id","end":""},{"old":"/competitions/:id/launch","type":0,"val":"launch","end":""}],
  ...
  'competitions.invite.form': {
    ...
    tokens: [{"old":"/competitions/:id/invite","type":0,"val":"competitions","end":""},{"old":"/competitions/:id/invite","type":1,"val":"id","end":""},{"old":"/competitions/:id/invite","type":0,"val":"invite","end":""}],
  ...
  'competitions.accept': {
    ...
    tokens: [{"old":"/competitions/:id/accept","type":0,"val":"competitions","end":""},{"old":"/competitions/:id/accept","type":1,"val":"id","end":""},{"old":"/competitions/:id/accept","type":0,"val":"accept","end":""}],
    types: placeholder as Registry['competitions.accept']['types'],
  },
  'competitions.decline': {
    methods: ["POST"],
    pattern: '/competitions/:id/decline',
    tokens: [{"old":"/competitions/:id/decline","type":0,"val":"competitions","end":""},{"old":"/competitions/:id/decline","type":1,"val":"id","end":""},{"old":"/competitions/:id/decline","type":0,"val":"decline","end":""}],
